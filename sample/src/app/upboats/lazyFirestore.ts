import { collection, query, orderBy, fromRef, updateDoc, doc, increment, serverTimestamp, addDoc } from '@angular/fire/firestore';
...
export const snapshotChanges = fromRef(animalsQuery).pipe(
